---
id: normal
title: "Shares & Dividends: Start Here"
---
...
| Concept clusters | 6 |
| Problem types | 18 |
| Meaningful variations | 48 |
| Core questions / subparts | 29 / 52 |
...
- **[Core](./practice.md):** 29 questions covering all 48 mapped variations. Four are original transfer questions; 25 come from the source. Solve independently before revealing solutions.
...
F = face value; M = market price; n = share count; I = investment; r = numerical dividend percentage; d = dividend per share; D = annual dividend; y = numerical yield percentage.

For these textbook problems, ignore charges and taxes unless supplied. Shares are whole units; unexpected fractions require checking the data. “Better investment” here means higher dividend yield under the supplied assumptions.
